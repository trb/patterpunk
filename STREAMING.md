...
| Claude 4.6+ | `reasoning_config={"type": "adaptive"}` + `output_config={"effort": ...}` | Sent as-is (4.6 clamps `xhigh` to `high`) | Coerced to an effort with a WARNING | Thinking off |
