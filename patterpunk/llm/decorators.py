...
"""
{
  ...
  "properties": {
    "subject_lines": {
      "items": [
        "Increase your billable hours by 13% with our email chronology builder!",
        "Maximize billable hours, minimize unbillable hours - 13% increase proven!",
        "Supercharge your billable hours - Reduce unbillable hours with our email chronology builder!",
        "Unlock more billable hours - Reduce unbillable hours with our email chronology builder!",
        "Boost billable hours by 13% - Streamline document review with our email chronology builder!"
      ],
      "title": "Subject Lines",
      "type": "array"
    }
...
"""
{
  ...
  "required": ["subject_lines"],
  "subject_lines": [
    "Boost Your Billable Hours with Goodfact's Email Chronology Builder",
    "Increase Your Billable Hours by 13% with Goodfact's Email Chronology Builder",
    "Maximize Billable Hours, Minimize Unbillable Time with Goodfact's Email Chronology Builder",
    "Supercharge Your Billable Hours: Reduce Unbillable Time with Goodfact's Email Chronology Builder",
    "Unlock 13% More Billable Hours: Boost Productivity with Goodfact's Email Chronology Builder",
    "Don't Miss Out on 13% More Billable Hours: Power Up with Goodfact's Email Chronology Builder"
  ]
}
"""
"""
    ...
    'properties':
        {
            'subject_lines': {
                'items': {
                    {'type': 'string'}, 'title': 'Subject Lines', 'type': 'array'
                }
            },
    'required': ['subject_lines'],
    'title': 'SubjectLines',
