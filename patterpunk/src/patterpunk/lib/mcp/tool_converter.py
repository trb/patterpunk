...
def _convert_mcp_schema_to_openai_parameters(mcp_schema: Dict[str, Any]) -> Dict[str, Any]:
    if not mcp_schema:
        return {
            "type": "object",
            "properties": {},
...
def extract_mcp_server_from_tool_call(tool_call_name: str, available_tools: ToolDefinition) -> str:
